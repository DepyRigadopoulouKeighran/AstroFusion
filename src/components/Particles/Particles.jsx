    ...
    <>
      ...
      >
        <div className="card cardFront">
          ...
          <img className="cardImageFrontParticles" src={andromeda} alt="" />
          <section className="cardSectionParticles">
            <h2 className="cardTitlesParticles">JUPITER - THE GIANT PLANET</h2>
            <p className="cardTextParticles">
            ...
            <h2 className="cardTitlesParticles">POTENTIAL FOR LIFE</h2>
            <p className="cardTextParticles">
        ...
        <div className="card cardBack">
          ...
          <img className="cardImageBackParticles" src={whirlpool} alt="" />
          <section className="cardSectionParticles">
            <h2 className="cardTitlesParticles">FUN FACTS ABOUT JUPITER</h2>
            <p className="cardTextParticles">
              <span className="spanParticles">Giant of the Solar System:</span>
              <br /> Jupiter is the largest planet in our solar system. It is
              more than twice as massive as all the other planets combined.
              <br />
              <br />
              <span className="spanParticles">Rapid Rotation:</span>
              ...
              <br />
              <br />
              <span className="spanParticles">Massive Magnetic Field: </span>
              ...
              <br />
              <br />
              <span className="spanParticles">Great Red Spot:</span>
              ...
              <br />
              <br />
              <span className="spanParticles">Jovian Atmosphere: </span>
              ...
              <br />
              <br />
              <span className="spanParticles">Fast-Moving Storms: </span>
              ...
              <br />
              <br />
              <span className="spanParticles">Europa's Ocean: </span>
              ...
              <br />
              <br />
              <span className="spanParticles">Spacecraft Exploration:</span>
            ...
            <h2 className="cardTitlesParticles">HISTORICAL EVENTS</h2>
            <p className="cardTextParticles">
              ...
              <br />
              <br />
              <span className="spanParticles">Voyager Missions (1979): </span>
            ...
            <h2 className="cardTitlesParticles">SPACE PHENOMENA</h2>
            <p className="cardTextParticles">
              ...
              <br />
              <br />
              <span className="spanParticles">Jovian Auroras: </span>
              ...
              <br />
              <br />
              <span className="spanParticles">Jupiter's Great Red Spot:</span>
              ...
              <br />
              <br />
              <span className="spanParticles">Jovian Magnetosphere: </span>
              ...
              <br />
              <br />
              <span className="spanParticles">Galilean Moons:</span>
              ...
              <br />
              <br />
              <span className="spanParticles">Jovian Rings:</span>
              ...
              <br />
              <br />
              <span className="spanParticles">Polar Cyclones:</span>
              ...
              <br />
              <br />
              <span className="spanParticles">Jovian Cloud Bands:</span>
              ...
              <br />
              <br />
              <span className="spanParticles">Io's Volcanic Activity:</span>
              ...
              <br />
              <br />
              <span className="spanParticles">Juno's Gravity Science:</span>
