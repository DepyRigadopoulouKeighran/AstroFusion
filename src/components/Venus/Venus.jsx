...
import './venus.css';
import venusFront from '../../images/venusFront.gif';
import venusBack from '../../images/venusBack.gif';
    ...
    <>
      ...
      >
        <div className="card cardFront">
          ...
          <img
            className="cardImageFrontVenus"
            src={venusFront}
            alt="planet Venus"
          />
          <section className="cardSectionBackVenus">
            <h2 className="cardTitlesBackVenus">VENUS - THE BLUE PLANET</h2>
            <p className="cardTextBackVenus">
        ...
        <div className="card cardBack">
          ...
          <img
            className="cardImageBackVenus"
            src={venusBack}
            alt="planet Venus"
          />
          <section className="cardSectionBackVenus">
            <h2 className="cardTitlesBackVenus">FUN FACTS ABOUT EARTH</h2>
            <p className="cardTextBackVenus">
              <span className="spanVenus">Blue Planet: </span>
              ...
              <br />
              <br />
              <span className="spanVenus">Only Known Habitable Planet: </span>
              ...
              <br />
              <br />
              <span className="spanVenus">Unique Moon:</span>
              ...
              <br />
              <br />
              <span className="spanVenus">Diverse Ecosystems:</span>
              ...
              <br />
              <br />
              <span className="spanVenus">Continental Drift: </span>
              ...
              <br />
              <br />
              <span className="spanVenus">Highest and Lowest Points: </span>
              ...
              <br />
              <br />
              <span className="spanVenus">Rotation and Orbit: </span>
            ...
            <p className="cardTextBackVenus">
              ...
              <br />
              <br />
              <span className="spanVenus">Mass Extinctions: </span>
              <br />
            ...
            <h2 className="cardTitlesBackVenus">SPACE PHENOMENA</h2>
            ...
            <p className="cardTextBackVenus">
              ...
              <br />
              <br />
              <span className="spanVenus">Auroras :</span>
              <br />
              ...
              <br />
              <span className="spanVenus">Meteor showers</span>
              ...
              <br />
              <br />
              <span className="spanVenus">Eclipses :</span>
              ...
              <br />
              <br />
              <span className="spanVenus">Gravity Assist </span>
              <br />
              ...
              <br />
              <br />
              <span className="spanVenus">Magnetosphere interactions</span>
