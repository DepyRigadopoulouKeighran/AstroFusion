...
import './neptune.css';
import neptuneFront from '../../images/neptuneFront.gif';
import neptuneBack from '../../images/neptuneBack.gif';
    ...
    <>
      <div className={`card-container${showFront ? '' : ' flipped'}`}>
        <div className="card cardFront">
          ...
          <img
            className="cardImageFrontNeptune"
            src={neptuneFront}
            alt="planet Neptune"
          />
          <section className="cardSectionBackNeptune">
            <h2 className="cardTitlesBackNeptune">EARTH - THE BLUE PLANET</h2>
            <p className="cardTextBackNeptune">
        ...
        <div className="card cardBack">
          ...
          <img
            className="cardImageBackNeptune"
            src={neptuneBack}
            alt="planet Neptune"
          />
          <section className="cardSectionBackNeptune">
            <h2 className="cardTitlesBackNeptune">FUN FACTS ABOUT EARTH</h2>
            <p className="cardTextBackNeptune">
              <span className="spanNeptune">Blue Planet: </span>
              ...
              <br />
              <br />
              <span className="spanNeptune">Only Known Habitable Planet: </span>
              ...
              <br />
              <br />
              <span className="spanNeptune">Unique Moon:</span>
              ...
              <br />
              <br />
              <span className="spanNeptune">Diverse Ecosystems:</span>
              ...
              <br />
              <br />
              <span className="spanNeptune">Continental Drift: </span>
              ...
              <br />
              <br />
              <span className="spanNeptune">Highest and Lowest Points: </span>
              ...
              <br />
              <br />
              <span className="spanNeptune">Rotation and Orbit: </span>
            ...
            <p className="cardTextBackNeptune">
              ...
              <br />
              <br />
              <span className="spanNeptune">Mass Extinctions: </span>
              <br />
            ...
            <h2 className="cardTitlesBackNeptune">SPACE PHENOMENA</h2>
            ...
            <p className="cardTextBackNeptune">
              ...
              <br />
              <br />
              <span className="spanNeptune">Auroras :</span>
              <br />
              ...
              <br />
              <span className="spanNeptune">Meteor showers</span>
              ...
              <br />
              <br />
              <span className="spanNeptune">Eclipses :</span>
              ...
              <br />
              <br />
              <span className="spanNeptune">Gravity Assist </span>
              <br />
              ...
              <br />
              <br />
              <span className="spanNeptune">Magnetosphere interactions</span>
