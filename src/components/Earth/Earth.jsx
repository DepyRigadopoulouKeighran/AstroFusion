    ...
    <>
      ...
      >
        <div className="card cardFront">
          ...
          <img
            className="cardImageFrontEarth"
            src={satelite}
            alt="Planet Earth"
          />
          <section className="cardSectionBackEarth">
            <h2 className="cardTitlesBackEarth">EARTH - THE BLUE PLANET</h2>
        ...
        <div className="card cardBack">
          ...
          <section className="cardSectionBackEarth">
            ...
            <p className="cardTextBackEarth">
              <span className="spanEarth">Blue Planet: </span>
              ...
              <br />
              <br />
              <span className="spanEarth">Only Known Habitable Planet: </span>
              ...
              <br />
              <br />
              <span className="spanEarth">Unique Moon:</span>
              ...
              <br />
              <br />
              <span className="spanEarth">Diverse Ecosystems:</span>
              ...
              <br />
              <br />
              <span className="spanEarth">Continental Drift: </span>
              ...
              <br />
              <br />
              <span className="spanEarth">Highest and Lowest Points: </span>
              ...
              <br />
              <br />
              <span className="spanEarth">Rotation and Orbit: </span>
              ...
              <br />
              <br />
              <span className="spanEarth">Magnetic Field: </span>
            ...
            <p className="cardTextBackEarth">
              ...
              <br />
              <br />
              <span className="spanEarth">Mass Extinctions: </span>
              <br />
