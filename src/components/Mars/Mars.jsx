      ...
      >
        <div className="card cardFront">
          ...
          <section className="cardSectionBackMars">
            <h2 className="cardTitlesBackMars">EARTH - THE BLUE PLANET</h2>
        ...
        <div className="card cardBack">
          ...
          <section className="cardSectionBackMars">
            <h2 className="cardTitlesBackMars">FUN FACTS ABOUT EARTH</h2>
            <p className="cardTextBackMars">
              <span className="spanMars">Blue Planet: </span>
              ...
              <br />
              <br />
              <span className="spanMars">Only Known Habitable Planet: </span>
              ...
              <br />
              <br />
              <span className="spanMars">Unique Moon:</span>
              ...
              <br />
              <br />
              <span className="spanMars">Diverse Ecosystems:</span>
              ...
              <br />
              <br />
              <span className="spanMars">Continental Drift: </span>
              ...
              <br />
              <br />
              <span className="spanMars">Highest and Lowest Points: </span>
              ...
              <br />
              <br />
              <span className="spanMars">Rotation and Orbit: </span>
            ...
            <p className="cardTextBackMars">
              ...
              <br />
              <br />
              <span className="spanMars">Mass Extinctions: </span>
              <br />
            ...
            <p className="cardTextBackMars">
              ...
              <br />
              <br />
              <span className="spanMars">Auroras :</span>
              <br />
              ...
              <br />
              <span className="spanMars">Meteor showers</span>
              ...
              <br />
              <br />
              <span className="spanMars">Eclipses :</span>
              ...
              <br />
              <br />
              <span className="spanMars">Gravity Assist </span>
              <br />
              ...
              <br />
              <br />
              <span className="spanMars">Magnetosphere interactions</span>
